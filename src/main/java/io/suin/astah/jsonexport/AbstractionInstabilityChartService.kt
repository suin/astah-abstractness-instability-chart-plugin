...
import io.suin.astah.jsonexport.astah.extension.abstractness
import io.suin.astah.jsonexport.astah.extension.allPackages
import io.suin.astah.jsonexport.astah.extension.hasClasses
import io.suin.astah.jsonexport.astah.extension.instability
...
class AbstractionInstabilityChartService(
    ...
    fun createChart(): IClassDiagram = try {
        ...
        val canvas =
            Canvas(diagramEditor, 1280.0, 720.0)
